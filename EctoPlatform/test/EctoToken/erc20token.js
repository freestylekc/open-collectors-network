...
contract('ERC20Token', (accounts) => {
    ...
    describe('transfer function', async () => {
        ...
        it("transfer > balance", async () => {
           ...
           await Utils.expectRevert(token.transfer.call(accounts[1], balance.add(1)), false)
        })
     ...
     describe('transferFrom function', async () => {
        ...
        it("transfer 1000 from account 0 -> 1 with 0 allowance", async () => {
           await Utils.expectRevert(token.transferFrom.call(accounts[0], accounts[1], 1000))
  
           await Utils.expectRevert(token.transferFrom.call(accounts[0], accounts[1], 1000, { from: accounts[1] }))
        })
